...
const PERFORMANCE_PROVIDER: Provider = {
  name: "signalswarm_performance",
  description:
    "Provides the agent's own SignalSwarm performance metrics including " +
  ...
  get: async (
    ...
    const agentId = runtime.getSetting("SIGNALSWARM_AGENT_ID") as string | null;
